...
public class horseBarnTest {
	...
	public void testSetUpSpaces() throws Exception {
		...
		assertEquals("Trigger", ((Horse) horseBarn.getSpaces()[0]).getName());
		assertEquals("Silver", ((Horse) horseBarn.getSpaces()[2]).getName());
		assertEquals("Lady", ((Horse) horseBarn.getSpaces()[3]).getName());
		assertEquals("Patches", ((Horse) horseBarn.getSpaces()[5]).getName());
		assertEquals("Duke", ((Horse) horseBarn.getSpaces()[6]).getName());
	}
